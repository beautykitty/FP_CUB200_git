...
from sampling import mnist_iid, mnist_noniid, mnist_noniid_unequal, mnist_noniid_lt, cub_noniid, cub_noniid_lt
...
def get_dataset(args, n_list, k_list, class_list):
    ...
    #### dadtaset name 정하기
        ...
        if args.iid:
            ...
            if args.unequal:
                ...
                # Chose euqal splits for every user
                user_groups, classes_list = cub_noniid(args, train_dataset, args.num_users, n_list, k_list)
                print("classes_list: ", classes_list)
                user_groups_lt = cub_noniid_lt(args, test_dataset, args.num_users, classes_list)
        
        
    # class_list 추가 
    return train_dataset, test_dataset, user_groups, user_groups_lt, classes_list
