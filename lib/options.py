...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='CUB_200_2011', help="name \
                        of dataset")
    ...
    parser.add_argument('--shots', type=int, default=30, help="num of shots")
    parser.add_argument('--train_shots_max', type=int, default=110, help="num of shots")
    # num of test shot
    parser.add_argument('--test_shots', type=int, default=10, help="num of shots")
    
    parser.add_argument('--stdev', type=int, default=0, help="stdev of ways")
    parser.add_argument('--ld', type=float, default=0.1, help="weight of proto loss")
    ## ld2
    parser.add_argument('--ld2', type=float, default=0.01, help="weight of proto loss")
